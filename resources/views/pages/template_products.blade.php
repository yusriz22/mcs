...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  ...
  <nav class="my-2 my-md-0 mr-md-3">
    <a class="p-2 text-dark" href="{{ route('page.home') }}">Home</a>
    <a class="p-2 text-dark" href="{{ route('page.about') }}">About</a>
    <a class="p-2 text-dark" href="{{ route('page.contact') }}">Contact</a>
    <a class="p-2 text-dark" href="{{ route('products.list') }}">Products</a>
  </nav>
  <a class="btn btn-outline-primary" href="{{ route('login') }}">Login</a>
</div>


<?php echo $senarai_products[0]['name']; ?>
